...
\item Single predecessor: $\preds[v] = \{u\} \implies \ldots$
  \begin{itemize}
  \item ...only successor $\succs[u] = \{v\} \implies \tfocands[v] = \{u\}$.
  \item ...other successors
    \begin{align*}
      \lvert \succs[u] \rvert > 1 \implies \tfocands[v] = \left\{ x \in \nodes \mid 
      \begin{align*}
        x \in \succs[u] \vee \\
        \left( \preds[x] = \{w\} \wedge w \in \tfocands[v] \right)
      \end{align*}
      \right\}
    \end{align*}
  \end{itemize}
