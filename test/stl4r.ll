...
define dso_local void @case_4(i32 %0) #0 {
  ...
  %8 = load i32, i32* %3, align 4 ; IGNORE
  %9 = zext i32 %7 to i64
  %10 = getelementptr inbounds [16 x i8], [16 x i8]* @secretarray, i64 0, i64 %9
  store i8 0, i8* %10, align 1
  %11 = load i32, i32* %3, align 4 ; IGNORE
  %12 = zext i32 %7 to i64
  %13 = getelementptr inbounds [16 x i8], [16 x i8]* @secretarray, i64 0, i64 %12
