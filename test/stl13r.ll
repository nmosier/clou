...
define dso_local zeroext i8 @case_11_load_value(i32 %0) #0 {
  ...
  %9 = load i32, i32* %3, align 4 ; %9 -> %8
  %10 = zext i32 %8 to i64
  %11 = getelementptr inbounds [16 x i8], [16 x i8]* @publicarray, i64 0, i64 %10
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define dso_local void @case_13(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i32 %0, i32* %2, align 4
  %4 = load i32, i32* %2, align 4
  %5 = call zeroext i8 @case_11_load_value(i32 %4)
  store i8 %5, i8* %3, align 1
  %6 = load i8, i8* %3, align 1 ; %6 -> %5
  %7 = zext i8 %6 to i32
  %8 = mul nsw i32 %7, 512
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [131072 x i8], [131072 x i8]* bitcast (<{ i8, [131071 x i8] }>* @publicarray2 to [131072 x i8]*), i64 0, i64 %9
  %11 = load i8, i8* %10, align 1
  %12 = zext i8 %11 to i32
  %13 = load volatile i8, i8* @temp, align 1
  %14 = zext i8 %13 to i32
  %15 = and i32 %14, %12
  %16 = trunc i32 %15 to i8
  store volatile i8 %16, i8* @temp, align 1
  ret void
}
